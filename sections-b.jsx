      ...
      <div className="footer__grid">
        <div>
          ...
          <div className="footer__socials">
            <a className="footer__soc footer__soc--li" href="https://www.linkedin.com/company/top-app-games/posts/?feedView=all" target="_blank" rel="noopener noreferrer" aria-label="TOP APP GAMES on LinkedIn">
              ...
              <span className="footer__soc-label">LinkedIn</span>
            </a>
          </div>
        </div>
