      ...
      <div className="footer__grid">
        ...
        <div className="footer__col">
          ...
          <ul>
            ...
            <li><a href="mailto:press@topapp.games">press@topapp.games</a></li>
            <li><a href="mailto:partners@topapp.games">partners@topapp.games</a></li>
            <li><a href="mailto:careers@topapp.games">careers@topapp.games</a></li>
          </ul>
        </div>
      </div>
